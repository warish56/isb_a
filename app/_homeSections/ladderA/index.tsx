            ...
            <div className={`${styles.content} body-wrapper-content`}>
                ...
                <div className={` ${styles.topic_cont} column gap-10`}>
                    <div className='column gap-20'>
                        ...
                        <span className=' text-body-4 color-text-primary '>India's Super Brain 2025 is bigger, better, and more rewarding than ever! This year, we've reimagined the competition to take you on an unforgettable journey of learning, innovation, and success.</span>
                    </div>
